...
#  5. Definirajte varijablu 
# min_duljina koja će pohranjivati minimalnu duljinu riječi int . Koristeći 
# odgovarajuću funkciju višeg reda i lambda izraz, pohranite u varijablu rijeci koje su dulje od min_duljina :
